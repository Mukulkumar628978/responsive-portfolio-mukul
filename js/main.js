...
tabs.forEach((tab) => {
  tab.addEventListener("click", () => {
    ...
    // Ative the tab and corresponding content
...
servicesButtons.forEach((button) => {
  ...
  const heigthInfo = document.querySelector(".services__info");
  heigthInfo.style.height = heigthInfo.scrollHeight + "px";
